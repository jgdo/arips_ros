...
public:
	...
	void Read(u8 ID, u8 MemAddr, u8 *nData, u8 nLen);//��ָ��
...
protected:
	...
	virtual void readSCS(unsigned char *nDat, int nLen) = 0;
...
private:
	...
	#define P_CCW_DEAD 27
        #define P_INTEGRAL_LIMIT_L 28
        #define P_INTEGRAL_LIMIT_H 29
