import roslib;roslib.load_manifest('arips_dashboard')
import rospy
...
class AripsDashboard(Dashboard):
    def setup(self, context):
        ...
        self._arips_bat = BatteryWidget("Arips")
    ...
    def dashboard_callback(self, msg):
        ...
        for status in msg.status:
            if status.name == "/Arips/Motor State":
                pass
